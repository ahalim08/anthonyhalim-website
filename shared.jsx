...
const CONTENT = {
  ...
  playground: [
    {
      title: 'Bookings Memo Builder',
      tag: 'Finance Policy',
      blurb:
        'Answer 12 policy decisions. Get a structured memo outline and a ready-to-use AI prompt.',
      status: 'Coming Soon',
    },
    {
  ...
  writing: [
    ...
    { title: 'A Booking is a Booking is a Booking (Until it Isn\'t)', date: 'May 2026', status: 'Published', url: '/writing/a-booking-is-a-booking' },
    { title: 'What does it cost to run Los Angeles?', date: 'June 2026', status: 'Draft' },
  ],
  contact: {
